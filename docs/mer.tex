...
\begin{tikzpicture}[node distance=7em]
    ...
    \node[attribute] (ban) at (0,2) {Banido} edge (user);
    ...
    \node[attribute] (subject-name) at (-2,-14) {\key{Nome}} edge (subject);
    \node[attribute] (subject-description) at (2,-14) {Descrição} edge (subject);
